questions = [
			...
			["1. (a) He knows it well/(b) that his success in life/(c) depends not onmy advice/(d) but on somebody else./(e) No error"],
			...
			[".5. (a) A gram’s weight/(b) is quite light for/(c) anyone to/(d) carryon his head./(e) No error"],
			[".6. (a) I stopped/(b) her going out late at night/(c) because thesituation/(d) in the town was very tense./(e) No error"],
			[".7. (a) She did not approve/(b) of her son raising/(c) stupidquestions and thereby/(d) annoying his tutor. /(e) No error"],
			[".8. (a) India’s problems/(b) are however /(c) not so serious/(d) andawful as Pakistan./(e) No error"],
			[".9. (a) His tone of speaking/(b) as well as his friends/(c) is reallyextremely rude/(d) yet we never take it seriously./(e) No error"],
			[".10. (a) The Defence Minister/(b) boasts of improving /(c) the militarypower of/(d) the country’s./(e) No error"],
			[".11. (a) The life of the homeless people/(b) is not in many/ (c) ways aspeaceful and luxurious/(d) as that of the rich’s/(e) No error"],
			[".12. (a)The CEO of the company said/(b) that he appreciated/(c) hisstaffs coming on time/(d) and co-operating him./(e) No error"],
			[".13. (a) As the students were told /(b) this idea of MahatmaGandhi’s/(c) was totally valid in the/(d) present condition ofIndia./(e) No error"],
			[".14. (a) It is true/(b) that I met/(c) the Prime Minister/(d) at the houseof one of my relative’s./(e) No error"],
			[".15. (a) The priest said/(b) to his followers that one ought/(c) to workhard in order/(d) to attain one goal./(e) No error"],
			[".16. (a) Being sure of her/(b) success, she told her parents/(c) that shewould never forget/(d) even her enemies’s names./(e) No error"],
			...
			[".19. (a) I appreciate she/(b) helping the destitute/(c) who are reallythe most ignored and completely deprived/(d) section of oursociety./(e) No error"],
			...
			[".23. (a) She suggested to me/(b) that I should go to the market/(c) tobring some beautiful/(d) summer’s flowers./(e) No error"],
			[".24. (a) He came to his wits end/(b) when he found/(c) that hisyounger/(d) brother had slapped his wife./(e) No error"],
			[".25. (a) When she arrived/(b) at the gate of his/(c) house, she foundhis/(d) locking up the door./(e) No error"],
			[".26. (a) India and Pakistan’s present/(b) condition clearly indicate/(c)that both the countries/(d) will face a lot of problems in thecoming time./(e) No error"],
			[".27. (a) Keeping in view/(b)the public’s demands/(c ) thegovernment has decided to introduce a new policy to improvethe quality and lower/(d) the prices of food grains./(e) No error"],
			[".28. (a) Many a citizen’s life is in danger/(b) if the Government doesnot take/(c) any serious action to/ (d) curb degradation ofenvironment. /(e) No error"],
			[".29. (a) My brother/(b) has read/(c) pages after pages/(d) of theRamayana./(e) No error"],
			[".30. (a) He went to/(b) the church with/(c) his parents, aunts/(d) andcousin sisters/(e) No error"],
			[".31. (a) She/(b) takes pain/(c) over her/(d) work. /(e) No error"],
			[".32. (a) Teacher told/(b) students that/(c) radiuses of a circle /(d) arealways equal./(e) No error"],
			[".33. (a) I like/(b) the poetries/(c) of Rabindranath Tagore /(d) andHarivansh Rai Bachchan./(e) No error"],
			...
			[".38. (a) All his brother-in laws/(b) are extremely co-operative/(c) andshe doesn’t miss her/(d) real brothers at all./(e) No error"],
			[".39. (a) He will not/(b) go to party tonight/(c) since he has/(d) manyworks to complete./ (e) No error"],
			[".40. (a) He wears spectacle/(b) and so he was /(c) unable to see theburglar /(d) that attacked him last month./(e) No error"],
			[".41. (a) Most of the furnitures were/(b) sold for a song/(c) as the sellerwas in a hurry/(d) to leave the town./(e) No error"],
			[".42. (a) She left/(b) her luggages/(c) at home by mistake and /(d)went to the railway station./ (e) No error"],
			[".43. (a) Sheila Dixit had/(b) been the administrator of Delhi/(c) formore/(d) than ten years./(e) No error"],
			[".44. (a) I think this/(b) is not your car/(c) It is/(d) somebody’s else./(e) No error"],
			[".45. (a) One should not put/(b) one’s sign /(c) on any paper/(d) thatone hasn’t read./(e) No error"],
			[".46. (a) Towns after towns were/(b) conquered/ (c) by Alexanderbut/(d) he found no peace anywhere./ (e) No error"],
			[".47. (a) Even after hours of discussion/ (b) the committee/(c) couldnot come/(d) to a final conclusion./(e) No error"],
			...
			[".50. (a) I am looking/(b) for a lady tailor/(c) to stitch a dress/(d) formy daughter./(e) No error"],
...
sol=    [				"Lets Start!",
						...
						"28. (e); No error",
						"29. (c); ‘Page after page’ should be used in place of ‘pages after pages’",
						"Since, a noun in singular form in used on the either side of a preposition",
						...
						"42. (b); ‘luggage’ should be used in place of ‘luggages’ 43. (b); ‘administratrix’ should be used in place of ‘administrator’. Since, ‘administratrix’ is the feminine form of administrator",
