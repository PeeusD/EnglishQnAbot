...
questions=[	 			 ["Fillers going to be start in 30 secs..."],
			 			 ...
			 			 ["Q.80. The soldiers received a military ______ to inspect all their vehicles before travelling. ","(a) allotment ","(b) dominion ","(c) affectation ","(d) calculation ","(e) mandate II. Double Fillers Directions: The Following questions have two blanks, each blank indicating that something has been omitted. Choose the set of words for each blank that best fits the meaning of the sentence as a whole."],
			 			 ["Q.81. It is a _____________ phase in this country’s history when the government at the Centre is seen to be actively assisting in a rightwing effort to ____________ the discourse on nationalism. ","(a) Dangerous, restructure ","(b) Tricky, model ","(c) Unsafe, build ","(d) Dangerous, shape ","(e) Chancy, figure"],
			 			 ["Q.82. Besides taking the __________ to the country’s campus that is most identified with Left politics, the JNU development was obviously a chance for the BJP to ____________ from the excesses of Hyderabad. ","(a) Conflict, offset ","(b) Dispute, harm ","(c) Contest, destroy ","(d) Encounter, resume ","(e) Fight, recover"],
			 			 ...
			 			 ["Q.84. Germany had been a nation ________in one country of numerous states which had a common language and __________. ","(a) Assembled, dialect ","(b) Assimilated, script ","(c) Embedded, civilization ","(d) United, traditions ","(e) Formed, code"],
			 			 ...
			 			 ["Q.87. The Deputy Manager ______________ to resign because all his proposals were _______________ down by his superiors. ","(a) Offered, thrown ","(b) Gave, held ","(c) Began, kept ","(d) Threatened, turned ","(e) Stopped, formed"],
			 			 ["Q.88. The revival of investment climate requires structural ________ besides substantially increasing public investment since private sector investment is ______________. ","(a) Making, temporary ","(b) Agenda, permanent ","(c) Improve, motionless ","(d) Reforms, stagnant ","(e) Rectify, dull"],
